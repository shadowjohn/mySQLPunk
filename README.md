...
目前發版版本：`v1.0.0.5`，最新版請看 [GitHub Releases](https://github.com/shadowjohn/mySQLPunk/releases)。
...
```powershell
.\scripts\package-release.ps1 -Version 1.0.0.5
```
...
- 樹狀清單的引擎圖示是用專屬色加形狀徽章區分（MySQL 圓、PostgreSQL 方、Oracle 三角、SQLite 菱形、SQL Server 橫槓），沒有用各家原廠 logo，因為商標授權不好處理。
