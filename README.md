...
目前發版版本：`v1.0.0.10`，最新版請看 [GitHub Releases](https://github.com/shadowjohn/mySQLPunk/releases)。
...
```powershell
.\scripts\package-release.ps1 -Version 1.0.0.10
```
