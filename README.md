...
目前發版版本：`v1.0.0.9`，最新版請看 [GitHub Releases](https://github.com/shadowjohn/mySQLPunk/releases)。
...
```powershell
.\scripts\package-release.ps1 -Version 1.0.0.9
```
...
#    已更新成要發布的版本，例如 1.0.0.9。
git tag v1.0.0.9
git push origin v1.0.0.9
```
