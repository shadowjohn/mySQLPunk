...
| SQL Dump | 可用 | Table dump 已支援 MySQL、PostgreSQL、SQLite、SQL Server、Oracle；Oracle dump 會輸出 schema-qualified INSERT、HEXTORAW、TO_TIMESTAMP literal，並保留 Primary Key、欄位註解與一般/唯一/空間索引 DDL |
