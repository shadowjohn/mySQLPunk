...
namespace mySQLPunk
{
    public static class Localization
    {
        ...
        static Localization()
        {
            ...
            Add("MongoDB.ReadOnlyFirstPhase", "MongoDB 第一階段僅支援唯讀 metadata、schema 推斷、JSON 查詢與文件分頁檢視。", "The first MongoDB phase supports read-only metadata, schema inference, JSON queries, and paged document viewing.");
            ...
            Add("MongoDB.ReadOnlyNote", "第一階段為唯讀：可瀏覽 collection/view、推斷欄位、查看索引並執行 JSON find 查詢。", "Phase one is read-only: browse collections/views, infer fields, inspect indexes, and run JSON find queries.");
