...
namespace mySQLPunk
{
    public static class Localization
    {
        ...
        static Localization()
        {
            ...
            Add("Ai.NoApiKeyHint", "尚未設定 API 金鑰：選項 > AI 可設定服務與金鑰（Ollama 本機模型不需要金鑰）。", "No API key configured: set the service and key in Options > AI (Ollama local models need no key).");
